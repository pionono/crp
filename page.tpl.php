          ...
          <div id="header-group-inner" class="header-group-inner inner clearfix">
            ...
            <div id="header-site-info" class="header-site-info block">
              <div id="header-site-info-inner" class="header-site-info-inner inner">
                <?php if ($logo): ?>
                <div id="logo">
                  <a href="http://www.regione.sardegna.it" title="Regione Autonoma della Sardegna"><img src="<?php print $logo; ?>" alt="Regione Autonoma della Sardegna" /></a>
                </div>
                <?php endif; ?>
...
<div id="Coda"> 
        ...
        <div class="inferiore"> 
          <ul> 
            <li class="salta-sezione"> 
              <a id="footer" href="#content">Vai al contenuto della pagina</a> 
            </li> 
            <li> 
              <a href="http://www.regione.sardegna.it/mappa.html" title="Vai alla pagina: mappa" target="_blank">mappa</a> 
            </li> 
            <li> 
              <a href="http://www.regione.sardegna.it/disclaimer.html" title="Vai alla pagina: note legali" target="_blank">note legali</a> 
            </li> 
            <li> 
              <a href="http://www.regione.sardegna.it/rubrica.html" title="Vai alla pagina: rubrica" target="_blank">rubrica</a> 
            </li> 
            <li class="ultimolink"> 
              <a href="http://www.regione.sardegna.it/rss/" title="Vai alla pagina: xml/rss" target="_blank">xml/rss</a> 
            </li> 
            <li class="salta-sezione"> 
              <a id="finepagina" href="#Testata">Vai all'inizio della pagina</a> 
            </li> 
          </ul> 
        </div> 
      </div> 
